...
/***/ 125:
/*!************************************************!*\
  !*** D:/four_grade_v1/movieApp/store/index.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 126));
...
var _default = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setMovies: function setMovies(state, movies) {
      state.cinemaMovies = movies;
    },
    setCurrentSelected: function setCurrentSelected(state, payload) {
      state.currentSelected = _objectSpread(_objectSpread({}, state.currentSelected), payload);
    },
    setCurrentSelectedShows: function setCurrentSelectedShows(state, shows) {
      state.currentSelected.shows = shows;
    },
    setCurrentSelectedPlist: function setCurrentSelectedPlist(state, plist) {
  ...
  actions: {
    ...
    fetchMovies: function fetchMovies(_ref2, cinemaId) {
      var commit = _ref2.commit,
        dispatch = _ref2.dispatch;
      uni.request({
        url: "https://apis.netstart.cn/maoyan/cinema/shows?cinemaId=".concat(cinemaId, "&ci=421"),
        method: 'GET',
    ...
    updateSelectedShows: function updateSelectedShows(_ref3) {
      ...
      if (state.cinemaMovies && state.currentSelected.movieId) {
        ...
        var currentDate = state.currentSelected.date;
        var movie = state.cinemaMovies.find(function (movie) {
          return movie.id === state.currentSelected.movieId;
        });
        console.log("找到的 movie:", movie); // 检查找到的电影数据
        if (movie) {
          console.log("zhixingmei1");
          var matchedShow = movie.shows.find(function (show) {
            return show.showDate === currentDate;
          });
    ...
    selectShow: function selectShow(_ref4, show) {
      var commit = _ref4.commit;
      commit('setCurrentSelectedPlist', show);
    },
    setCurrentSelected: function setCurrentSelected(_ref5, payload) {
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"movieApp","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 26:
/*!********************************************!*\
  !*** D:/four_grade_v1/movieApp/pages.json ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 31:
/*!**********************************************************!*\
  !*** D:/four_grade_v1/movieApp/uni.promisify.adaptor.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 48:
/*!****************************************************!*\
  !*** D:/four_grade_v1/movieApp/utils/seat-data.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 89:
/*!*************************************************************************************************!*\
  !*** D:/four_grade_v1/movieApp/uni_modules/uni-icons/components/uni-icons/uniicons_file_vue.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
